 ...
 * The default port is `8000`, allowing the client to connect to the server on this port.
 */
#define DEFAULT_PORT 8000       /**< Default port number for communication */


/**
 * @struct MenuMessage
 * @brief Represent the menu text that will be sent to the client.
 *
 * char 'menu_text` holds the text of the menu, which is
 * displayed to the client upon a successful connection. The maximum size
