...
#include <string.h>
#include <stdbool.h>
#include "./src/libs/protocol/protocol.h"  /**< Include protocol header for message structures and communication formats */
#include "./src/libs/utils/utils.h"	   /**< Include the utils.h library for utility functions */
...
int main() {
	...
	do {
		...
		if(password_msg.type == 'q'){
			response_msg.keep_going = false;
		} else {
