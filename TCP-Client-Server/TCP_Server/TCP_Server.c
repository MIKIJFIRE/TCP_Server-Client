...
#include "./src/libs/password/password.h"  /**< Include the header for password generation functions */
#include "src/libs/protocol/protocol.h"  /**< Include the protocol definitions for communication */
